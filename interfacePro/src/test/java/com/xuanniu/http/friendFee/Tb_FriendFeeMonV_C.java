...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午4:09:58 
* 类说明 
*/ 
...
public class Tb_FriendFeeMonV_C {
...
//	String mobile1 = "99913920031";
	...
	// ----
	public Tb_FriendFeeMonV_C(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void Tb_FriendFeeMonV_CTest() throws InterruptedException {
		...
		BigDecimal exp_service_change = mon_fee_service.multiply(new BigDecimal("0.09"));
