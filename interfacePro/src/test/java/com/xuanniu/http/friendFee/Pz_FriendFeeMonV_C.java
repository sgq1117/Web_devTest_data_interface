...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午3:17:24 
* 类说明 
*/ 
...
public class Pz_FriendFeeMonV_C {
...
//	 String mobile1 = "99913920032";
	...
	// ----
	public Pz_FriendFeeMonV_C(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void Pz_FriendFeeMonV_CTest() throws InterruptedException {
		System.out.println("====第一个配资人、配资 98w、推荐人收 98w管理费 * 14%====");
		/*
		...
		BigDecimal exp_service_change = mon_fee_service.multiply(new BigDecimal("0.14"));
