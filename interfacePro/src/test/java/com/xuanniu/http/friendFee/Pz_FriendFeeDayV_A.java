...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月12日 上午11:54:16 
 * 类说明 
 */
...
public class Pz_FriendFeeDayV_A {
	...
	// -------------------------------
	// ----投标
	String tbPzMobile_Va = "99913920001";
	...
	// -----
	public Pz_FriendFeeDayV_A(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	@Test
	public void friendFeeDayVATest() throws InterruptedException {
		System.out.println("===={第一个配资人、配资8w、推荐人收 8w管理费*14%}====");
		/*
