...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午3:36:41 
* 类说明 
*/ 
...
public class Tb_FriendFeeDayV_E {
...
//	 String mobile1 = "99913920034";
	...
	// -----
	public Tb_FriendFeeDayV_E(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	@Test
	public void Tb_FriendFeeDayV_ETest() throws InterruptedException {
		System.out.println("===={第二个投标人、投标 1w、 推荐人收 1w管理费*15%}=={投标人和被推荐人是同一个人}==");
		/*
