...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午3:04:32 
* 类说明 
*/ 
...
public class Pz_FriendFeeDayV_C {
...
//	String mobile1 = "99913920032";
	...
	// -----
	public Pz_FriendFeeDayV_C(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "490000", "1", "", "2", "3", "1", "980000" } };
		return Arrays.asList(object);
	}
	@Test
	public void Pz_FriendFeeDayV_CTest() throws InterruptedException {
		System.out.println("===={第一个配资人、配资 98w、推荐人收 98w管理费 * 18%}====");
		/*
...
//		 */
		...
		BigDecimal exp_service_change = day_fee_service.multiply(new BigDecimal("0.18"));
