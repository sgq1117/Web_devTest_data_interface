...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午3:36:35 
* 类说明 
*/ 
@RunWith(Parameterized.class)
public class Tb_FriendFeeDayV_D {
...
//	 String mobile1 = "99913920033";
	...
	// -----
	public Tb_FriendFeeDayV_D(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	@Test
	public void Tb_FriendFeeDayV_DTest() throws InterruptedException {
		...
		BigDecimal exp_service_change = day_fee_service.multiply(new BigDecimal("0.15"));
