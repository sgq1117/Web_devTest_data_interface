...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午3:36:20 
* 类说明 
*/ 
...
public class Tb_FriendFeeDayV_B {
...
//	String mobile1 = "99913920031";
	...
	// -----
	public Tb_FriendFeeDayV_B(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "5000", "1", "", "2", "4", "1", "10000" } };
		return Arrays.asList(object);
	}

	
	@Test
	public void Tb_FriendFeeDayV_BTest() throws InterruptedException {
		...
		BigDecimal exp_service_change = day_fee_service.multiply(new BigDecimal("0.13"));
