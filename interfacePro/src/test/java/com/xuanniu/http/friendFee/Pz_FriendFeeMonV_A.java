...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月4日 上午11:13:55 
 * 类说明 
 */
...
public class Pz_FriendFeeMonV_A {
	...
	// ----
	public Pz_FriendFeeMonV_A(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void friendFeeVATest() throws InterruptedException {
		System.out.println("====第一个配资人、配资 8w、推荐人收 8w管理费 * 12%====");
		/*
		...
		BigDecimal exp_service_change = mon_fee_service.multiply(new BigDecimal("0.12"));
