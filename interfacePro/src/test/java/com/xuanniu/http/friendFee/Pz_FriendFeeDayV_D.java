...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午3:04:39 
* 类说明 
*/ 
...
public class Pz_FriendFeeDayV_D {
...
//	 String mobile1 = "99913920033";
	...
	// -----
	public Pz_FriendFeeDayV_D(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	@Test
	public void Pz_FriendFeeDayV_DTest() throws InterruptedException {
		System.out.println("===={第一个配资人、配资 98w、推荐人收 98w管理费 * 20%}====");
		/*
...
//		 */
		...
		BigDecimal exp_service_change = day_fee_service.multiply(new BigDecimal("0.2"));
