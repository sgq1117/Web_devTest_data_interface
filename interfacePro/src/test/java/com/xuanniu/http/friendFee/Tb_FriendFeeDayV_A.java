...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月12日 下午1:41:49 
 * 类说明 
 */
...
public class Tb_FriendFeeDayV_A {
	...
	// -----
	public Tb_FriendFeeDayV_A(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "4000", "1", "", "2", "1", "1", "8000" } };
		return Arrays.asList(object);
	}

	@Test
	public void TbFriendFeeDayV_ATest() throws InterruptedException {
		System.out.println("===={第一个投标人、投标 0.8w、推荐人收 0.8w管理费*12%}=={投标人和被推荐人是同一个人}==");
		/*
...
//		System.out.println("平台增加: "+day_fee_service);
		BigDecimal exp_service_change = day_fee_service.multiply(new BigDecimal("0.12"));
