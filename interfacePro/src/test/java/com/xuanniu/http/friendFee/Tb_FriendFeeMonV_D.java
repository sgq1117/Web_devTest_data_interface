...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午4:10:06 
* 类说明 
*/ 
...
public class Tb_FriendFeeMonV_D {
...
//	String mobile1 = "99913920031";
	...
	// ----
	public Tb_FriendFeeMonV_D(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void Tb_FriendFeeMonV_DTest() throws InterruptedException {
		System.out.println("===={ 第二个投标人、投标 20w、 推荐人收 20w管理费*15%}=={投标人和被推荐人是同一个人}==");
		...
		BigDecimal exp_service_change = mon_fee_service.multiply(new BigDecimal("0.1"));
