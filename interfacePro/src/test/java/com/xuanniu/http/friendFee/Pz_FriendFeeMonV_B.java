...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午3:17:12 
* 类说明 
*/ 
...
public class Pz_FriendFeeMonV_B {
...
//	String mobile1 = "99913920031";
	...
	// ----
	public Pz_FriendFeeMonV_B(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void Pz_FriendFeeMonV_BTest() throws InterruptedException {
		System.out.println("====第一个配资人、配资 8w、推荐人收 8w管理费 * 13%====");
		/*
		...
		BigDecimal exp_service_change = mon_fee_service.multiply(new BigDecimal("0.13"));
