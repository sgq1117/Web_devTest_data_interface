...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午3:17:40 
* 类说明 
*/ 
...
public class Pz_FriendFeeMonV_E {
...
//	 String mobile1 = "99913920034";
	...
	// ----
	public Pz_FriendFeeMonV_E(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void Pz_FriendFeeMonV_ETest() throws InterruptedException {
		System.out.println("====第一个配资人、投资 10w、推荐人收 10w管理费 * 15% ====");
		/*
