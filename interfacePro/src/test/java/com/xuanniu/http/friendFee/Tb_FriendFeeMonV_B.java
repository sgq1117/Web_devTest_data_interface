...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月13日 下午4:09:52 
 * 类说明 
 */
...
public class Tb_FriendFeeMonV_B {
...
//	String mobile1 = "99913920031";
	...
	// ----
	public Tb_FriendFeeMonV_B(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void Tb_FriendFeeMonV_BTest() throws InterruptedException {
		System.out.println("===={ 第二个投标人、投标 1w、  推荐人收 1w管理费*13%}=={投标人和被推荐人是同一个人}==");
		/*
		...
		BigDecimal exp_service_change = mon_fee_service.multiply(new BigDecimal("0.08"));
