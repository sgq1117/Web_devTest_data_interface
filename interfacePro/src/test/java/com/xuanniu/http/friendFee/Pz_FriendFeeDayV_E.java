...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午3:04:46 
* 类说明 
*/ 
...
public class Pz_FriendFeeDayV_E {
...
//	String mobile1 = "99913920031";
	...
	// -----
	public Pz_FriendFeeDayV_E(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "50000", "1", "", "2", "1", "1", "100000" } };
		return Arrays.asList(object);
	}
	
	@Test
	public void Pz_FriendFeeDayV_ETest() throws InterruptedException {
