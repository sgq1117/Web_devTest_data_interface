...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月9日 上午11:16:03 
 * 类说明 
 */
...
public class PzTb_Day_C {
	/**
	 * 天配资、满标、续期、前台申请终止、后台终止
	 */
	...
	public PzTb_Day_C(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount, String pZchangeamount, String tBchangeamount, String pTchangeamount) {
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "5000", "1", "", "3", "4", "1", "15000", "72", "27", "45" },
				{ "5000", "1", "", "3", "4", "2", "15000", "72", "27", "45" } };
		return Arrays.asList(object);

	}

	@Test
	public void PzTb_Day_C_Test() throws InterruptedException {
		System.out.println("===={CASE1: 按天配资、发标的、投标、开账户、资金划转、初次满标、前台申请终止、后台终止}====");
		/*
		 ...
		 * step3、前台申请终止
		 */
		hlfb.terminalApplyPost(financing_contract_sn, applyPzMobile, Password);
		Thread.sleep(2000);
		/*
		 * step4、后台结算终止
		 */
		 ...
		 * step6、
		 */
//		System.out.println("act1、配资人： 可用余额减少: " + act_pz_change);
		System.out.println("act2、投标人： 可用余额增加：" + act_tb_change);
//		System.out.println("act3、平台：    可用余额增加 ：" + act_pt_change);
		/*
		 * step7、 1、期待配资人可用余额减少 服务费==>18*4=72 2、期待投标人可用余额增加 利息===>
		 * 18元/天*0.3.375*4=27 3、期待平台货币账户余额增加 =====>18元/天 0.625 * 4=45
		 */
...
//		System.out.println("exp1、配资人： 可用余额减少: " + exp_pz_change);
		System.out.println("exp2、投标人： 可用余额增加：" + exp_tb_change);
//		System.out.println("exp3、平台：    可用余额增加 ：" + exp_pz_change);
