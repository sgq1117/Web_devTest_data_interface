...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月9日 上午11:35:14 
 * 类说明 
 */
...
public class PzTb_Mon_C {
	...
	// ----------
	public PzTb_Mon_C(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount, String pZchangeamount, String tBchangeamount, String pTchangeamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void PzTb_Mon_C_Test() throws InterruptedException {
		System.out.println("===={CASE1: 按月配资满标、发标的、投标、开账户、资金划转、初次满标、前台申请终止、后台终止}====");
		/*
		...
		/*
		 * step7 1、投资人减少：所有（已付利息+服务费)+(未付利息+服务费)的20%:
		...
		// ----
		// BigDecimal exp_pz_basic = PzCalcMoney.getMonFee_pz_less(margin,
		// ruleId, "0", "0", interest);
		//----服务费+利息+罚息
