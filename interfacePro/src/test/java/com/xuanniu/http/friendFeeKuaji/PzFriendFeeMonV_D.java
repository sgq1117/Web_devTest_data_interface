...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月11日 下午1:40:12 
 * 类说明 
 */
...
public class PzFriendFeeMonV_D {
	...
	// ----
	public PzFriendFeeMonV_D(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void friendFeeVDTest() throws InterruptedException {
		System.out.println("第二个配资人、配资 98w、推荐人收 (100-14)w管理费 *14% + 12w管理费*15%");
		/*
		...
		// ----第二档减少的比率 、borrow_2:二档配资总额 ：|| borrow_A2：二档还可计算服务费用的额度
		BigDecimal borrow_2 = new BigDecimal("1000000");
		BigDecimal borrow_A2 = borrow_2.subtract(new BigDecimal("140000"));

		// ----第一档减少的比率、金额
		BigDecimal mon_fee_service_A2 = PzCalcMoney.getMonFee_service_borrow(borrow_A2, ruleId, "0");
		BigDecimal exp_service_change_A2 = mon_fee_service_A2.multiply(new BigDecimal("0.14"));
		System.out.println("-------第一档----:"+exp_service_change_A2);

		// ----第二档减少的比率、金额
		BigDecimal borrow_B2 = borrowAll.subtract(borrow_A2);
		BigDecimal mon_fee_service_B2 = PzCalcMoney.getMonFee_service_borrow(borrow_B2, ruleId, "0");
		BigDecimal exp_service_change_B2 = mon_fee_service_B2.multiply(new BigDecimal("0.15"));
		System.out.println("-------第二档----:"+exp_service_change_B2);
		

		// ----总共减少
		BigDecimal exp_service_change_2 = exp_service_change_A2.add(exp_service_change_B2);
		System.out.println("付给推荐人的服务费是： " + exp_service_change_2);

		// ----断言
		assertEquals(0, act_plat_change.compareTo(act_tj_change));
		assertEquals(0, act_plat_change.compareTo(exp_service_change_2));
		assertEquals(0, act_tj_change.compareTo(exp_service_change_2));
	}
