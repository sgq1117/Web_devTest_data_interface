...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午1:10:16 
* 类说明 
*/ 
...
public class TbFriendFeeDayV_E {
...
//	String mobile1 = "99913920031";
	...
	// -----
	public TbFriendFeeDayV_E(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	@Test
	public void TbFriendFeeDayV_ETest() throws InterruptedException {
		System.out.println("===={第一个投标人、投标1w、  推荐人收1w管理费 * 15%}====");
		/*
