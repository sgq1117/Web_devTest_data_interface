...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月11日 下午4:38:19 
 * 类说明 
 */
...
public class PzFriendFeeMonV_E {
	...
	// ----
	public PzFriendFeeMonV_E(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "", "50000", "2", "", "11", "4", "1.9", "1", "100000" } };
		return Arrays.asList(object);
	}

	@Test
	public void PzFriendFeeMonVETest() throws InterruptedException {
		System.out.println("====第一个配资人、配资10w、推荐人收 10w管理费 * 20% ====");
		/*
		...
		BigDecimal mon_fee_service_E = PzCalcMoney.getMonFee_service_borrow(borrowAll, ruleId, "0");
		// ----总共减少
		BigDecimal exp_service_change_E = mon_fee_service_E.multiply(new BigDecimal("0.15"));

		System.out.println("付给推荐人的服务费是： " + exp_service_change_E);

		// ----断言
		assertEquals(0, act_plat_change.compareTo(act_tj_change));
		assertEquals(0, act_plat_change.compareTo(exp_service_change_E));
		assertEquals(0, act_tj_change.compareTo(exp_service_change_E));
