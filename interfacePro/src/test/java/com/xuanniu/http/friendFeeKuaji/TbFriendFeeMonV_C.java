...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午1:10:48 
* 类说明 
*/ 
...
public class TbFriendFeeMonV_C {
...
//	String mobile1 = "99913920031";
	...
	// ----
	public TbFriendFeeMonV_C(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "", "25000", "2", "", "11", "4", "1.9", "1", "50000" } };
		return Arrays.asList(object);
	}

	@Test
	public void TbFriendFeeMonV_CTest() throws InterruptedException {
		System.out.println("===={第一个投标人、投标 5w、  推荐人收 (4-0.8)w 管理费*8% + 1.8w管理费*9%}==");
		/*
		...
		BigDecimal exp_service_change_A1 = mon_fee_service_A1.multiply(new BigDecimal("0.08"));
		...
		BigDecimal exp_service_change_B1 = mon_fee_service_B1.multiply(new BigDecimal("0.09"));
