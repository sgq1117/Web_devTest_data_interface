...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午1:09:06 
* 类说明 
*/ 
...
public class TbFriendFeeDayV_C {
	...
	// -----
	public TbFriendFeeDayV_C(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	@Test
	public void TbFriendFeeDayV_CTest() throws InterruptedException {
		System.out.println("===={第一个投标人、投标5w、  推荐人收 (4-0.8)w 管理费*13% + 1.8w 管理费 *14%}==");
		/*
		...
		BigDecimal borrow_1 = new BigDecimal("40000");
		BigDecimal borrow_A = borrow_1.subtract(new BigDecimal("8000"));

		// ----第一档减少的比率、金额
		BigDecimal day_fee_service_A = PzCalcMoney.getDayFee_SumService_borrow_pt(borrow_A, "0", usedate, p2pInterestByDay);
		BigDecimal exp_service_change_A = day_fee_service_A.multiply(new BigDecimal("0.13"));
		...
		BigDecimal exp_service_change_B = day_fee_service_B.multiply(new BigDecimal("0.14"));
