...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月13日 上午10:44:22 
 * 类说明 
 */
...
public class PzFriendFeeDayV_B {
	...
	// -----
	public PzFriendFeeDayV_B(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	@Test
	public void PzFriendFeeDayVBTest() throws InterruptedException {
		System.out.println("====第二个配资人、配资8w、推荐人收 (10-8)w管理费 * 14% + 6w管理费*16%====");
		/*
		...
		BigDecimal borrow_A = borrow_1.subtract(new BigDecimal("80000"));
		...
		BigDecimal exp_service_change_B = day_fee_service_B.multiply(new BigDecimal("0.16"));
