...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午1:10:58 
* 类说明 
*/ 
...
public class TbFriendFeeMonV_E {
...
//	String mobile1 = "99913920031";
	...
	// ----
	public TbFriendFeeMonV_E(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void TbFriendFeeMonV_ETest() throws InterruptedException {
		System.out.println("===={第一个投标人、投标 1w、  推荐人收 1w管理费 * 10%}==");
		/*
