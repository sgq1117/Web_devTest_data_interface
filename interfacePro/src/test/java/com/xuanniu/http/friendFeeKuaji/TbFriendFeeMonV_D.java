...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月13日 下午1:10:53 
 * 类说明 
 */
...
public class TbFriendFeeMonV_D {
	...
	// ----
	public TbFriendFeeMonV_D(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "", "100000", "2", "", "11", "4", "1.9", "1", "200000" } };
		return Arrays.asList(object);
	}

	@Test
	public void TbFriendFeeMonV_DTest() throws InterruptedException {
		...
		BigDecimal borrow_A1 = borrow_1.subtract(new BigDecimal("18000"));

		// ----第一档减少的比率、金额
		BigDecimal mon_fee_service_A1 = PzCalcMoney.getMonFee_service_borrow(borrow_A1, ruleId, "0");
		BigDecimal exp_service_change_A1 = mon_fee_service_A1.multiply(new BigDecimal("0.09"));
		...
		BigDecimal exp_service_change_B1 = mon_fee_service_B1.multiply(new BigDecimal("0.1"));
