...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月13日 下午1:08:46 
 * 类说明 
 */
...
public class TbFriendFeeDayV_B {
	...
	// -----
	public TbFriendFeeDayV_B(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "5000", "1", "", "2", "1", "1", "10000" } };
		return Arrays.asList(object);
	}

	@Test
	public void TbFriendFeeDayV_BTest() throws InterruptedException {
		System.out.println("===={第二个投标人、投标1w、  推荐人收 (1-0.8）w管理费*12% + 0.8w管理费 *13%}==");
		/*
		...
		BigDecimal exp_service_change_A = day_fee_service_A.multiply(new BigDecimal("0.12"));
		...
		BigDecimal exp_service_change_B = day_fee_service_B.multiply(new BigDecimal("0.13"));
