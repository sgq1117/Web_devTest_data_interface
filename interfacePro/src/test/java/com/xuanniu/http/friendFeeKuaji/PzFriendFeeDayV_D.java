...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 上午10:44:37 
* 类说明 
*/ 
...
public class PzFriendFeeDayV_D {
	...
	// -----
	public PzFriendFeeDayV_D(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "490000", "1", "", "2", "1", "1", "980000" } };
		return Arrays.asList(object);
	}

	@Test
	public void PzFriendFeeDayV_DTest() throws InterruptedException {
		System.out.println("====第二个配资人、配资98w、推荐人收(100-14) w管理费*18% + 12w管理费* 20%====");
		/*
		...
		BigDecimal borrow_1 = new BigDecimal("1000000");
		BigDecimal borrow_A = borrow_1.subtract(new BigDecimal("140000"));

		// ----第一档减少的比率、金额
		BigDecimal day_fee_service_A = PzCalcMoney.getDayFee_SumService_borrow_pt(borrow_A, "0", usedate,p2pInterestByDay);
		BigDecimal exp_service_change_A = day_fee_service_A.multiply(new BigDecimal("0.18"));
		...
		BigDecimal exp_service_change_B = day_fee_service_B.multiply(new BigDecimal("0.20"));
