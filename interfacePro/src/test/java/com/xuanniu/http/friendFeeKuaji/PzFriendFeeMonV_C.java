...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月11日 上午10:05:50 
 * 类说明 
 */
...
public class PzFriendFeeMonV_C {
	...
	// ----
	public PzFriendFeeMonV_C(String sn, String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String interest, String tradeAccountApplyWay, String tBamount) {
		this.sn = sn;
		this.margin = margin;
	...
	@Test
	public void friendFeeVCTest() throws InterruptedException {
		System.out.println("第三个配资人、配资 98w、推荐人收 (90-6)w管理费 *13% + 14w管理费*14% ");
		/*
		...
		BigDecimal borrow_2 = new BigDecimal("900000");
		BigDecimal borrow_A2 = borrow_2.subtract(new BigDecimal("60000"));

		// ----第一档减少的比率、金额
		BigDecimal mon_fee_service_A2 = PzCalcMoney.getMonFee_service_borrow(borrow_A2, ruleId, "0");
		BigDecimal exp_service_change_A2 = mon_fee_service_A2.multiply(new BigDecimal("0.13"));
		...
		BigDecimal exp_service_change_B2 = mon_fee_service_B2.multiply(new BigDecimal("0.14"));
