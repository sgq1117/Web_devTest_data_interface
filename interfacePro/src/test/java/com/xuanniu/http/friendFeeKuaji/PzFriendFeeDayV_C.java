...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 上午10:44:31 
* 类说明 
*/ 
...
public class PzFriendFeeDayV_C {
	...
	// -----
	public PzFriendFeeDayV_C(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	@Test
	public void PzFriendFeeDayV_CTest() throws InterruptedException {
		System.out.println("====第一个配资人、配资98w、推荐人收 (90-6）w管理费* 16% + 14w管理费*18%====");
		/*
		...
		BigDecimal borrow_1 = new BigDecimal("900000");
		BigDecimal borrow_A = borrow_1.subtract(new BigDecimal("60000"));

		// ----第一档减少的比率、金额
		BigDecimal day_fee_service_A = PzCalcMoney.getDayFee_SumService_borrow_pt(borrow_A, "0", usedate,p2pInterestByDay);
		BigDecimal exp_service_change_A = day_fee_service_A.multiply(new BigDecimal("0.16"));
		...
		BigDecimal exp_service_change_B = day_fee_service_B.multiply(new BigDecimal("0.18"));
