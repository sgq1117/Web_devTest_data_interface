...
/** 
* @author sungq 
* @version 创建时间：2015年6月13日 下午1:09:50 
* 类说明 
*/ 
...
public class TbFriendFeeDayV_D {
	...
	// -----
	public TbFriendFeeDayV_D(String margin, String usedateUnit, String tradeAccountId, String ruleId, String usedate, String tradeStartTime, String tBamount) {
		this.margin = margin;
	...
	public static Collection prepareData() {
		Object[][] object = { { "100000", "1", "", "2", "1", "1", "200000" } };
		return Arrays.asList(object);
	}
	
	@Test
	public void TbFriendFeeDayV_DTest() throws InterruptedException {
		System.out.println("===={第二个投标人、投标 20w、 推荐人收 (15-1.8)w 管理费*9% + 6.8w管理费*10%}==");
		/*
		...
		System.out.println("day_p2p_contrac" + "t_id is: " + p2p_contract_id);
		...
		BigDecimal borrow_1 = new BigDecimal("150000");
		BigDecimal borrow_A = borrow_1.subtract(new BigDecimal("18000"));

		// ----第一档减少的比率、金额
		BigDecimal day_fee_service_A = PzCalcMoney.getDayFee_SumService_borrow_pt(borrow_A, "0", usedate, p2pInterestByDay);
		BigDecimal exp_service_change_A = day_fee_service_A.multiply(new BigDecimal("0.14"));
		System.out.println("day_fee_service_A:" + day_fee_service_A);
		System.out.println("exp_service_change_A: " + exp_service_change_A);

		// ----第二档减少的比率、金额
		BigDecimal borrow_B = borrowAll.subtract(borrow_A);
		BigDecimal day_fee_service_B = PzCalcMoney.getDayFee_SumService_borrow_pt(borrow_B, "0", usedate, p2pInterestByDay);
		BigDecimal exp_service_change_B = day_fee_service_B.multiply(new BigDecimal("0.15"));
		System.out.println("day_fee_service_B:" + day_fee_service_B);
		System.out.println("exp_service_change_B: " + exp_service_change_B);
		// ----总共减少
		BigDecimal exp_service_change = exp_service_change_A.add(exp_service_change_B);
