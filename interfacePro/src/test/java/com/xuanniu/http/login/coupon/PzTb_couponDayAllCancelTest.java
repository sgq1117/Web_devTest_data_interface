...
/** 
* @author sungq 
* @version 创建时间：2015年6月2日 下午3:06:06 
* 类说明 
*/ 
...
public class PzTb_couponDayAllCancelTest {
...
//	String tbPzPassword_Vb = "123456";
	...
	@Test
	public void PzTbcouponDayAllCancelTest() {
		System.out.println("===={CASE2_1: 按天配资 Gift、发标的、投标Gift、初次未满标、后台终止}====");
		/*
		 ...
		 * step4、投标
		 */
		hlfb.pzTbGiftGet(financing_contract_id, p2p_contract_id, tbGiftId, tBamount, tbPzMobile_Va, tbPzPassword_Va);
		/*
		 *  step5: 未满标取消标的
		 */
//		hlbb.cancelNoManBiaoPost(financing_contract_id);
		/*
		 * step6、执行前检查配资人、债权人的账户余额情况、
		 ...
		 * 2、投標人減少：投标金、得到的利息:-15000+285+50=-14665.0000
		 * 3、平台增加： 利息：60
		 */
		BigDecimal exp_pz_change = new BigDecimal("5295");
		BigDecimal exp_tb_change = new BigDecimal("14665");
		BigDecimal exp_pl_change = new BigDecimal("0");
