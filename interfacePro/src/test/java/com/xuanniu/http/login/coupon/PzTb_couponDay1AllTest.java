...
/** 
 * @author sungq 
 * @version 创建时间：2015年6月2日 上午11:47:58 
 * 类说明 
 */
...
public class PzTb_couponDay1AllTest {
	...
	@Test
	public void pzTbCouponDay1AllTest() {
		System.out.println("===={天配资、投标都用红包、交易日为今天}====");
		/*
		 ...
		 * 2、投标人減少：投标金、得到的利息<9元/天*0.3=2.7>:-15000+2.7*2+50=-14944.6
		 * 3、平台增加： 利息：<9元/天 * 0.7 * 4 = 25.2> ==25.2
		 */
		BigDecimal exp_pz_change = new BigDecimal("4986");
		BigDecimal exp_tb_change = new BigDecimal("14944.6");
