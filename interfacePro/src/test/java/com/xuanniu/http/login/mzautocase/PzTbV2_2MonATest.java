...
/** 
 * @author sungq 
 * @version 创建时间：2015年5月28日 下午2:57:44 
 * 类说明 
 */
...
public class PzTbV2_2MonATest {
	...
	@Test
	public void test() {
		System.out.println("===={CASE2_2: 月配资 、发标的、投标、开账户、资金划转、初次满标、前台申请终止、后台终止}====");
		/*
		 ...
		 * 2、期待债权人可用余额增加：　首月利息　＋　罚息　(285*0.2*3*0.3) 　=　285 + 51.3
		 * =336.3 
