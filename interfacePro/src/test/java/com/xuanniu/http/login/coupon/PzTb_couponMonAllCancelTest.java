...
/** 
* @author sungq 
* @version 创建时间：2015年6月2日 下午2:46:25 
* 类说明 
*/ 
...
public class PzTb_couponMonAllCancelTest {
...
//	String tbPzPassword_Vb = "123456";
	...
	@Test
	public void PzTbcouponMonAllCancelTest() {
		System.out.println("===={CASE2_1: 按月配资 Gift、发标的、投标Gift、初次未满标、后台终止}====");
		/*
		 ...
		 * 2、投標人減少：投标金、得到的利息:-1000+50=-14665.0000
		 * 3、平台增加： 利息：60
		 */
		BigDecimal exp_pz_change = new BigDecimal("5295");
		BigDecimal exp_tb_change = new BigDecimal("9950");
